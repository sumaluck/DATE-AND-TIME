...
$(function(){
	$('#pre').on('click',function(){
		...
		$('#hello').html(
				"<table border='2px solid black'><tr><th>sun</th><th>mon</th><th>tue</th><th>wed</th><th>thr</th><th>fri</th><th>sat</th></tr>"
		+"<tr>"
		+"<td>"+(--a)+"</td>"
		+"<td>"+(--a)+"</td>"
		+"<td>"+(--a)+"</td>"
...
<input type="hidden" id="abc" value="4">
<div id="hello">
...
/* 
	$("#selectall").click(function() {
	    ...
	    var position=$(rows).find("td:eq(1)").text();
